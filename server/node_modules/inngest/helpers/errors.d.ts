...
declare namespace errors_d_exports {
  export { ErrCode, OutgoingResultError, PrettyError, SerializedError$1 as SerializedError, deserializeError$1 as deserializeError, fixEventKeyMissingSteps, functionStoppedRunningErr, getErrorMessage, isSerializedError, minifyPrettyError, prettyError, prettyErrorSplitter, rethrowError, serializeError$1 as serializeError };
}
